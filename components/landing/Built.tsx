            ...
            <SectionFrame
                ...
                contentNode={
                    <>
                        ...
                        <p className="section-content-para">In fast-moving businesses, growth can create pressure before it creates stability. Teams grow quickly, priorities shift, managers become overstretched, and important people decisions start happening too late or without enough structure. </p>
